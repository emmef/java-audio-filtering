...
public class SampleWriter {
	...
	public static void write8(int value, OutputStream stream) throws IOException  {
		stream.write(value);
	}
	...
	public static void write8(int value, byte[] buffer, int offset) {
	...
	private static void writeLongLsb(long value, OutputStream stream) throws IOException {
